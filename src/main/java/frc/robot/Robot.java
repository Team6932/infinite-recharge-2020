...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    System.out.println(variables.testMotor);
    System.out.println(variables.testMotorSpeed);

    System.out.println("Gyro Angle = " + robot.m_imu.getAngle());
  ...
  public void autonomousInit() {
    ...
    System.out.println("Auto selected: " + robot.m_autoSelected);// prints the variable

    variables.time = System.currentTimeMillis();
  ...
  public void autonomousPeriodic() {
    ...
    switch (robot.m_autoSelected) {
      ...
      switch(variables.autoStep) {
        case 0: {
          if (System.currentTimeMillis() <= variables.time + 5000){
            System.out.println("Turn angle = " + gyroAxis());
            robot.drive.arcadeDrive(0.5, -gyroAxis());
          }else {
            variables.autoStep++;
          }
          break;
